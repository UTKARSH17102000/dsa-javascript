...
description: SRS interval calculator and review mode assignment for spaced repetition pattern cards. Use when running /dsa-review, calculating next review dates, assigning Full/Snippet/Blitz review modes, or when Sprint Mode rules are needed.
---
...
## Bail-Out Triggers
If user says `timeout`, `blank`, or `no clue` at any point during a problem → rate Blank, show full card immediately, move on.

## Mode Execution
See REFERENCE.md for Full / Snippet / Blitz step-by-step execution,
