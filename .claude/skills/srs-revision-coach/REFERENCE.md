...
2. Cheatsheet Prime: look up card's Pattern Tag in `dsa-prep/notes/cheatsheets/cheatsheet-index.md`, output one line: `📖 [tag] → [file] § [section]`. Full mode only — skip for Snippet/Blitz.
...
2. Prompt: "Write comments for parts you know cold + full code for the parts you think are tricky."
...
Sprint = first 2 SRS review cycles after a fresh solve. Announce "🏃 Sprint active" at start of each sprint review.
...
| Stage 2 | Sprint Day+3 | Snippet | Write full JS boilerplate cold. No peeking at card or cheatsheet. |
